...
rule germline:
    ...
    shell:
        """
        germline -input ped/imputed_chr{wildcards.chrom}.ped cm/chr{wildcards.chrom}.cm.map -homoz -min_m 2.5 -err_hom 2 -err_het 1 -w_extend -output germline/chr{wildcards.chrom}.germline | tee {log}
